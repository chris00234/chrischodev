  ...
  return (
    ...
    >
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-2">
          {project.tech.map((tech, idx) => (
            <span
              key={idx}
              className="px-2 py-1 bg-slate-800 text-slate-300 rounded-md text-sm font-mono group-hover:bg-primary-900/20 group-hover:text-primary-300 transition-colors duration-300"
            >
              {tech}
            </span>
          ))}
      ...
      <div className="flex space-x-3">
        ...
        <button className="flex items-center space-x-2 px-4 py-2 glass-effect text-slate-300 text-sm rounded-lg hover:glow-effect hover:text-white transition-all duration-200">
          <Github size={14} />
          <span>Code</span>
        </button>
      </div>
    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center">
          <button className="px-8 py-3 glass-effect text-primary-400 font-semibold rounded-lg hover:glow-effect transform hover:scale-105 transition-all duration-200">
            View All Projects
          </button>
        </div>
        ...
        <div className="mt-20 text-center">
          <div className="glass-effect rounded-xl p-8 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="px-6 py-3 glass-effect text-primary-400 font-semibold rounded-lg hover:glow-effect transform hover:scale-105 transition-all duration-200">
                Schedule a Call
              </button>
            </div>
          </div>
